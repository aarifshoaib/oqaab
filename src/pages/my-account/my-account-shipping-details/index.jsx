...
import OrderDetails from "@/components/my-account/ShippingDetails";
import React from "react";

import MetaComponent from "@/components/common/MetaComponent";
const metadata = {
  title:
    "My Account Order Details || OQAAB - Premium JDM & Racing T-Shirts | Titans, Bikes & Car Tees Online",
...
export default function MyAccountShippingDetailsPage() {
  return (
    <>
          ...
          <div className="container-full">
            <div className="row">
              <div className="col-12">
                <h3 className="heading text-center">Shipping Details</h3>
