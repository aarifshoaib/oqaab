                      ...
                      <div className="tf-product-info-desc">
                        <div className="tf-product-info-price">
                          <h5 className="price-on-sale font-2">
                            {" "}
                            <span className="uae-icon" title="aed" /> {" "} {product.price?.toFixed(2)}
                          </h5>
                          {product.oldPrice ? (
                            <>
                              <div className="compare-at-price font-2">
                                {" "}
                                <span className="uae-icon" title="aed" /> {" "} {product.oldPrice?.toFixed(2)}
                              </div>
                    ...
                    <div className="tf-product-info-choose-option">
                      ...
                      <div className="tf-product-info-help">
                        ...
                        <div className="tf-product-info-time">
                          ...
                          <p className="text-caption-1">
                            Estimated Delivery: <span>1 - 3 days</span> (UAE)
                          </p>
                        </div>
